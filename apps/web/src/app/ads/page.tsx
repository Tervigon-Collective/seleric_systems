...
export default async function AdsPage({
  ...
  try {
    ...
    data = await fetchAdsDashboardData(range, brand)
  ...
  return (
    ...
    <main className="p-6 space-y-6">
      ...
      <header className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-stone-500 dark:text-night-500 mt-1">
            ...
            Ad performance & attribution · {brandText} · {rangeLabel} · ROAS = purchase_value / ad_spend
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <ChartCard title="Spend by hour of day" subtitle="hourly_window dimension" cube="ad_performance">
        ...
        <ChartCard title="Attribution vs actual spend" subtitle="Attributed net sales by campaign" cube="dw_meta_ads_attribution">
        ...
        <ChartCard title="Video & engagement KPIs" subtitle="Period totals + daily trend" cube="marketing_performance" className="xl:col-span-2">
